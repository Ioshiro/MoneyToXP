...
local function OnFillInventoryObjectContextMenu(playerIndex, context, items)
    ...
    if player:getMoodles():getMoodleLevel(MoodleType.FoodEaten) >= 3 and player:getNutrition():getCalories() >= 1000 then
        ...
        subMenuSkills:addOption("Recipe_Train_Aim", playerIndex, onDroga, Perks.Axe, items)
        subMenuSkills:addOption("Recipe_Train_Aim", playerIndex, onDroga, Perks.Aiming, items)
        subMenuSkills:addOption("Recipe_Train_Carpentry", playerIndex, onDroga, Perks.Woodwork, items)
        subMenuSkills:addOption("Recipe_Train_Cooking", playerIndex, onDroga, Perks.Cooking, items)
        subMenuSkills:addOption("Recipe_Train_Electrical", playerIndex, onDroga, Perks.Electricity, items)
        subMenuSkills:addOption("Recipe_Train_Farming", playerIndex, onDroga, Perks.Farming, items)
        subMenuSkills:addOption("Recipe_Train_First_Aid", playerIndex, onDroga, Perks.Doctor, items)
        subMenuSkills:addOption("Recipe_Train_Fishing", playerIndex, onDroga, Perks.Fishing, items)
        subMenuSkills:addOption("Recipe_Train_Fitness", playerIndex, onDroga, Perks.Fitness, items)
        subMenuSkills:addOption("Recipe_Train_Foraging", playerIndex, onDroga, Perks.PlantScavenging, items)
        subMenuSkills:addOption("Recipe_Train_Lightfoot", playerIndex, onDroga, Perks.Lightfoot, items)
        subMenuSkills:addOption("Recipe_Train_Long_Blade", playerIndex, onDroga, Perks.LongBlade, items)
        subMenuSkills:addOption("Recipe_Train_Maintenance", playerIndex, onDroga, Perks.Maintenance, items)
        subMenuSkills:addOption("Recipe_Train_Mechanics", playerIndex, onDroga, Perks.Mechanics, items)
        subMenuSkills:addOption("Recipe_Train_Metalworking", playerIndex, onDroga, Perks.MetalWelding, items)
        subMenuSkills:addOption("Recipe_Train_Nimble", playerIndex, onDroga, Perks.Nimble, items)
        subMenuSkills:addOption("Recipe_Train_Reloading", playerIndex, onDroga, Perks.Reloading, items)
        subMenuSkills:addOption("Recipe_Train_Short_Blade", playerIndex, onDroga, Perks.SmallBlade, items)
        subMenuSkills:addOption("Recipe_Train_Short_Blunt", playerIndex, onDroga, Perks.SmallBlunt, items)
        subMenuSkills:addOption("Recipe_Train_Long_Blunt", playerIndex, onDroga, Perks.Blunt, items)
        subMenuSkills:addOption("Recipe_Train_Sneak", playerIndex, onDroga, Perks.Sneak, items)
        subMenuSkills:addOption("Recipe_Train_Spear", playerIndex, onDroga, Perks.Spear, items)
        subMenuSkills:addOption("Recipe_Train_Sprinting", playerIndex, onDroga, Perks.Sprinting, items)
        subMenuSkills:addOption("Recipe_Train_Strength", playerIndex, onDroga, Perks.Strength, items)
        subMenuSkills:addOption("Recipe_Train_Trapping", playerIndex, onDroga, Perks.Trapping, items)
        subMenuSkills:addOption("Recipe_Train_Tailoring", playerIndex, onDroga, Perks.Tailoring, items)
    end
end
